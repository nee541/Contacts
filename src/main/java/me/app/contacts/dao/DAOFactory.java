 ...
 * the dao.properties file configuration. You can obtain DAO's for the DAO factory instance using the
 * DAO getters.
 * <p>
 * This class requires a dao.properties file named 'dao.dao.properties' in the classpath with among others
 * the following dao.properties:
 * <pre>
 * name.url *
 * name.driver
 * name.username
 ...
 * with username/password preconfigured, you can omit the username and password dao.properties as well.
 * <p>
 * Here are basic examples of valid dao.properties for a database with the name 'javabase':
 * <pre>
...
public abstract class DAOFactory {
     ...
     * @throws DAOConfigurationException If the database name is null, or if the dao.properties file is
     * missing in the classpath or cannot be loaded, or if a required property is missing in the
     * dao.properties file, or if either the driver cannot be loaded or the datasource cannot be found.
     */
    ...
    /**
     * Returns the Contact DAO associated with the current DAOFactory.
     * @return The Contact DAO associated with the current DAOFactory.
     */
    public ContactDAO getContactDAO() {
        return (ContactDAO) new ContactDAOJDBC(this);
    }
